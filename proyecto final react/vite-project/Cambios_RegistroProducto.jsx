...
const Cambios_RegistroProducto = () => {
    ...
    return (
        <div>
            <h1>Cambios_RegistroProducto</h1>
            <form id="formulario_Cambios_RegistroProducto" onSubmit={handleSubmit}>
...
export default Cambios_RegistroProducto;
