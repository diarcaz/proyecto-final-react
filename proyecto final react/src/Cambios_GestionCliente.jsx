...
const Cambios_GestionCliente = () => {
    ...
    return (
        <div>
            <h1>Cambios_GestionCliente</h1>
            <form id="formulario_Cambios_GestionCliente" onSubmit={handleSubmit}>
...
export default Cambios_GestionCliente;
